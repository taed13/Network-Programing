...
public class CalculatorClientUI extends JFrame implements ActionListener {
    public static void main(String[] args) throws Exception {
        new CalculatorClientUI();
    }

    private JLabel portLabel, label;
    private JTextField inputField, portField;
    private JTextArea resultArea;
    private JButton equalButton, connectButton;
    ...
    public CalculatorClientUI() {
        ...
        panel.add(equalButton, BorderLayout.EAST);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == equalButton) {
            String bieuthuc = inputField.getText();
            // Gửi biểu thưc tới server
            try {
                dos.writeUTF(bieuthuc);
                dos.flush();
                kb = kb.reset();
